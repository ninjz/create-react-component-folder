...
/**
 * Creates React Native Typescript stateless functional component
 *
 * @param {String} componentName - Component name
 * @returns {String}
 */
function createTypeScriptReactNativeFunctionalComponent(componentName) {
  const name = stringHelper.componentNameWithoutSpecialCharacter(componentName);
...
/**
 * Creates Stories for React Native component
 *
 * @param {String} componentName - Component name
 * @param {Boolean} upperCase - If true then capitalize first letter
 * @param {Boolean} isTypeScript - Boolean check for Typescript
 * @returns {String}
 */
function createReactNativeComponentStories(componentName, upperCase, isTypeScript) {
  const componentNameUpperCase = stringHelper.capitalizeFirstLetter(componentName);
  const componentNameWithoutSpecialCharacter = stringHelper.componentNameWithoutSpecialCharacter(
    componentName,
  );
...
module.exports = {
  ...
  createTypeScriptReactNativeFunctionalComponent,
  ...
  createReactNativeComponentStories,
};
